...
class IntervalRunningView4: UIView {
    
    private lazy var distanceQuestionLabel: UILabel = {
        let label = UILabel()
        label.text = "Задайте темп для быстрых отрезков"
...
//        backgroundColor = .red
    ...
    @objc func paceSliderDidSlide(_ sender: UISlider!) {
        ...
        DataManager.shared.set(key: "TempoForFastSegments", value: userSetPace)
    }
}
