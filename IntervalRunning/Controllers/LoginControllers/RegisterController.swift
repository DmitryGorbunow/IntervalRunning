...
class RegisterController: UIViewController {
    ...
    private let signUpButton = CustomButton(title: "Регистрация", hasBackground: true, fontSize: .big)
    private let signInButton = CustomButton(title: "Уже есть аккаунт? Войдите.", fontSize: .med)
